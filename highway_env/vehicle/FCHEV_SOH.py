...
class FCHEV_SOH:
    def __init__(self):
        ...
        self.P_FC_high = 0.9 * self.P_FC_max
    ...
    def run_fuel_cell(self, P_fc):
        ...
        info = {"P_fc": P_fc, "P_fce": P_fce, "fce_eff": fce_eff, "dcdc_eff": dcdc_eff, "h2_fcs": h2_fcs, "P_dcdc": P_dcdc}
    ...
    def run_FC_SOH(self, P_fc):
        ...
        out_info = {"d_s_s": d_s_s, "d_low": d_low, "d_high": d_high, "d_l_c": d_l_c, "FCS_De": FCS_De}
        self.P_FC_old = P_fc
