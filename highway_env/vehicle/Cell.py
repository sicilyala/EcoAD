...
class CellModel_1:
    ...
    def run_cell(self, P_batt, SOC, Tep_c, Tep_s):
        ...
        out_info = {
            "SoC": SOC_new,
            "battery_temperature": Tep_a,
            "accumulated_Ah": self.accumulated_Ah,
...
class CellModel_2:
    def __init__(self):
        ...
        self.ocv_func = pickle.load(open("../../FCHEV_power_data/ocv.pkl", "rb"))
    ...
    def run_cell(self, P_batt, paras_list):
        ...
        Ic_rate = abs(I_batt / self.Cn)  # I_batt: I of one single cell
